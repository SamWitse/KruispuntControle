...
type
  TForm1 = class(TForm)
    ...
    procedure ZuidNoordAutoGeneratorTimer(Sender: TObject);
    procedure OostWestAutoGeneratorTimer(Sender: TObject);
  private
...
procedure TForm1.ZuidNoordAutoGeneratorTimer(Sender: TObject);
var
...
procedure TForm1.OostWestAutoGeneratorTimer(Sender: TObject);
var
  Laag, Hoog, tpp: integer ;
  Auto: TAuto ;
  Reisweg: TReisweg ;
